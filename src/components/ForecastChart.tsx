...
import { getEffectiveAmount, getEstimatedPaymentDate, getInstallmentDates, getInstallmentValue } from '../utils';
    ...
    transactions.forEach(t => {
      if (t.type === 'expense') {
        if (t.isInstallment && t.installmentsTotal) {
          ...
          dates.forEach(d => {
            if (d.getMonth() === forecastDate.getMonth() && d.getFullYear() === forecastDate.getFullYear()) {
              monthSpecificDebt += installmentValue;
            }
          });
